...
const TranslatorDict = (() => {
  const ADVANCED_SUBTITLE_LEXICON = {
    ...
    // Advanced Subtitle Dialogue, High-Stakes Confrontations & Line-for-Line Cinema Expressions
    "i'm not afraid of you": { kurdish: 'لە تۆ ناترسم', context: 'Defiance', alternatives: ['ترسم لە تۆ نییە', 'باکم بە تۆ نییە', 'ناتوانیت بمترسێنیت'] },
    "i am not afraid of you": { kurdish: 'لە تۆ ناترسم', context: 'Defiance', alternatives: ['ترسم لە تۆ نییە', 'باکم بە تۆ نییە'] },
    "i won't let you get away with this": { kurdish: 'ناهێڵم بە ئاسانی لێی دەرباز بیت', context: 'Justice/Threat', alternatives: ['ناهێڵم بێ سزادران بڕۆیت', 'ڕێگەت پێ نادەم دەربازت بێت'] },
    "you will pay for what you've done": { kurdish: 'باجی کردەوەکانت دەدەیت', context: 'Retribution', alternatives: ['سزای کارەکانت وەردەگریتەوە', 'پەشیمانت دەکەمەوە'] },
    "you'll pay for what you did": { kurdish: 'باجی ئەوەی کردت دەدەیت', context: 'Retribution', alternatives: ['سزای کارەکەت دەبینیتەوە'] },
    'what did you expect': { kurdish: 'چاوەڕوانی چیت دەکرد؟', context: 'Rhetorical Question', alternatives: ['پێشبینی چیت دەکرد؟', 'گومانت لەوە هەبوو؟'] },
    "you've got a lot of nerve": { kurdish: 'زۆر بێشەرمانە ڕەفتار دەکەیت', context: 'Confrontation', alternatives: ['زۆر چاونەترسیت', 'ڕووت زۆر قایمە'] },
    "you have a lot of nerve": { kurdish: 'ڕووت زۆر قایمە', context: 'Confrontation', alternatives: ['زۆر چاونەترسیت'] },
    "don't play dumb with me": { kurdish: 'خۆت لە نەزانی مەدە لەگەڵمدا', context: 'Interrogation', alternatives: ['خۆت گێل مەکە', 'وا خۆت پیشان مەدە نازانیت'] },
    "don't play stupid": { kurdish: 'خۆت گێل مەکە', context: 'Interrogation', alternatives: ['خۆت لە نەزانی مەدە'] },
    "it's none of your concern": { kurdish: 'پەیوەندی بە تۆوە نییە', context: 'Dismissal', alternatives: ['کێشەی تۆ نییە', 'دەست لەمە وەرمەدە'] },
    'stay out of this': { kurdish: 'دەست لەم بابەتە وەرمەدە', context: 'Warning', alternatives: ['تێکەڵی ئەمە مەبە', 'خۆت بەدوور بگرە'] },
    "i didn't mean to hurt you": { kurdish: 'مەبەستم نەبوو ئازارت بدەم', context: 'Remorse', alternatives: ['نەمویست دڵت بشکێنم', 'نەمدەویست ئازارت پێ بگات'] },
    'you broke your promise': { kurdish: 'پەیمانەکەت شکاند', context: 'Betrayal', alternatives: ['بەڵێنەکەت نەبردە سەر', 'پەیمانت پێشکاند'] },
    'give me one good reason': { kurdish: 'یەک هۆکاری بڕواپێکەرم پێ بدە', context: 'Demand', alternatives: ['هۆکارێکی باشم پێ بڵێ', 'بەڵگەیەکی تەواوم نیشان بدە'] },
    "i don't have all day": { kurdish: 'هەموو ڕۆژەکەم لەبەردەست نییە بۆ چاوەڕوانی', context: 'Impatience', alternatives: ['پەلەمە', 'کاتم کەمە'] },
    'make yourself at home': { kurdish: 'وەک ماڵی خۆت سەیری بکە', context: 'Hospitality', alternatives: ['ڕەحەت بە', 'هیچ شەرم مەکە'] },
    'you can count on me': { kurdish: 'دەتوانیت پشتم پێ ببەستیت', context: 'Reliability', alternatives: ['متمانەم پێ بکە', 'پشتت تێناکەم'] },
    'i will never forgive you': { kurdish: 'هەرگیز لێت خۆش نابم', context: 'Grudge', alternatives: ['تا مردن لە گەردنت ئازاد ناکەم', 'هەرگیز گەردنت ئازاد ناکەم'] },
    'it was an accident': { kurdish: 'ڕووداوێکی نەخوازراو بوو', context: 'Defense', alternatives: ['بە مەبەست نەبوو', 'بەڕێکەوت ڕوویدا'] },
    "what's done is done": { kurdish: 'ئەوەی ڕوویدا، تەواو بوو', context: 'Acceptance', alternatives: ['ڕابردوو ناگەڕێتەوە', 'پەشیمانی سوودی نییە'] },
    "we're running out of options": { kurdish: 'هەڵبژاردنەکانمان بەرەو نەمان دەچن', context: 'Crisis', alternatives: ['چارەسەرمان کەم دەبێتەوە', 'ڕێگەکانمان بەرتەسک دەبنەوە'] },
    'trust your instincts': { kurdish: 'متمانە بە هەستی ناخت بکە', context: 'Guidance', alternatives: ['گوێ لە دڵت بگرە', 'باوەڕت بە هەستت هەبێت'] },
    "it's a matter of time": { kurdish: 'تەنها پەیوەستە بە کاتەوە', context: 'Inevitable', alternatives: ['کاتی دەوێت و ڕوودەدات', 'تەنها کاتی ماوە'] },
    'you have my word': { kurdish: 'بەڵێنت پێدەدەم', context: 'Promise', alternatives: ['پەیمانم پێدایت', 'قسەی پیاوانەیە'] },
    'take your time': { kurdish: 'پەلە مەکە', context: 'Patience', alternatives: ['بە هێمنی کارەکەت بکە', 'کاتی خۆت وەربگرە'] },
    'be my guest': { kurdish: 'فەرموو، ئازاد بە', context: 'Permission', alternatives: ['بە دڵی خۆت بکە', 'سەرپشک بە'] },
    "don't hold your breath": { kurdish: 'هێندە دڵت بەوە خۆش مەکە', context: 'Skepticism', alternatives: ['چاوەڕوانی ئەوە مەبە', 'ڕوونادات'] },
    'suit yourself': { kurdish: 'هەرچی پێت باشە ئەوە بکە', context: 'Concession', alternatives: ['سەرپشکی لە بڕیارەکەت', 'وەک ئارەزووی خۆت'] },
    'fair enough': { kurdish: 'قبووڵکراو و دادپەروەرانەیە', context: 'Agreement', alternatives: ['ڕاستە و هاوڕام', 'پێم پەسەندە'] },
    'serves you right': { kurdish: 'شایەنی ئەوە بوویت', context: 'Justice/Spite', alternatives: ['حەقی خۆت بوو', 'دەستی خۆتە'] },
    'what a pity': { kurdish: 'چەندە جێگەی داخە', context: 'Sympathy', alternatives: ['مەخابن', 'داخەکەم'] },
    'what a shame': { kurdish: 'چەندە جێگەی شەرمەزاری و داخە', context: 'Disappointment', alternatives: ['بەداخەوە بۆ ئەوە'] },
    'good for you': { kurdish: 'ئافەرین بۆت', context: 'Approval/Sarcasm', alternatives: ['پیرۆزت بێت', 'دەستخۆشیت لێدەکەم'] },
    'shame on you': { kurdish: 'شەرمەزار بە', context: 'Disapproval', alternatives: ['ڕووت ڕەش بێت', 'عەیبە بۆ تۆ'] },
    'god forbid': { kurdish: 'خوای نەکردە', context: 'Prayer/Avoidance', alternatives: ['پەنا بە خوا', 'دوور بێت'] },
    'heaven forbid': { kurdish: 'ڕەبی دوور بێت', context: 'Prayer', alternatives: ['خوای نەکردە'] },
    "for heaven's sake": { kurdish: 'لەبەر خاتری خوا', context: 'Exasperation', alternatives: ['لەپێناو بەزەییدا', 'تکایە بەسی بکە'] },
    'for goodness sake': { kurdish: 'لەبەر خاتری خوا', context: 'Exasperation', alternatives: ['بەسی بکە'] },
    'over and out': { kurdish: 'پەیوەندی کۆتایی هات', context: 'Radio Signoff', alternatives: ['تەواو و دەرچووم'] },
    'roger that': { kurdish: 'پەیامەکەم بەڕوونی وەرگرت', context: 'Acknowledgment', alternatives: ['تێگەیشتم', 'فەرمانەکەت ڕوونە'] },
    'copy that': { kurdish: 'پەیامەکەت گەیشت', context: 'Acknowledgment', alternatives: ['تێگەیشتم'] },
    'mayday mayday': { kurdish: 'هاواری فریاگوزاری بەپەلە!', context: 'Distress Signal', alternatives: ['هانابردن بۆ ڕزگارکردن!'] },
    'fire in the hole': { kurdish: 'خۆتان بشارنەوە، تەقینەوە ڕوودەدات!', context: 'Explosion Warning', alternatives: ['پەنا بگرن لە تەقینەوە!'] },
    'stand down immediately': { kurdish: 'دەستبەجێ چەک دابنێ و پاشەکشە بکە', context: 'Order', alternatives: ['بۆستە لە شوێنی خۆت'] },
    'to the death': { kurdish: 'تا دوا دڵۆپی خوێن / تا مەرگ', context: 'Duel to Death', alternatives: ['تا لەناوچوونی کۆتایی'] },
    'rest assured': { kurdish: 'دڵنیابە و دڵت ئاو بخواتەوە', context: 'Comfort', alternatives: ['خەمت نەبێت و دڵنیابە'] },
    'have faith': { kurdish: 'باوەڕت هەبێت و بێهیوا مەبە', context: 'Hope', alternatives: ['ئیمانت بەهێز بێت'] },
    "you're not alone": { kurdish: 'تۆ بەتەنیا نیت', context: 'Support', alternatives: ['من لەگەڵتم', 'پشتت دەگرم'] },
    "i'm all ears": { kurdish: 'بە تەواوی گوێم لێتە', context: 'Attention', alternatives: ['هەموو سەرنجم لای قسەکانتە'] },
    'cat got your tongue': { kurdish: 'بۆچی بێدەنگ بوویت و زمانت گیراوە؟', context: 'Mocking Silence', alternatives: ['زمانت لێ گیراوە؟'] },
    'food for thought': { kurdish: 'بابەتێک بۆ تێڕامان و بیرکردنەوە', context: 'Intellectual Reflection' },
    'in cold blood': { kurdish: 'بە دڵڕەقی و بێبەزەییانە', context: 'Cruelty', alternatives: ['بە خوێنێکی ساردەوە'] },
    'behind closed doors': { kurdish: 'لە ژووری داخراو و بە نهێنی', context: 'Secrecy' },
    'caught red handed': { kurdish: 'لە کاتی ئەنجامدانی تاوانەکەدا دەستگیرکرا', context: 'Busted', alternatives: ['دەستبەجێ لەسەر کارەکە گیرا'] },
    'at gunpoint': { kurdish: 'لەژێر هەڕەشەی چەکدا', context: 'Hostage/Coercion', alternatives: ['بە لولەی دەمانچە'] },
    'against the clock': { kurdish: 'لە پێشبڕکێدا لەگەڵ کاتدا', context: 'Urgency', alternatives: ['بە کاتێکی زۆر دیاریکراو'] },
    'easier said than done': { kurdish: 'وتنی ئاسانە بەڵام کردنی گرانە', context: 'Difficulty' },
    'actions speak louder than words': { kurdish: 'کردار شەرتە نەک تەنها قسە', context: 'Proverb' },

    // Advanced Cinematic, Literary & Philosophical Nuance Vocabulary
    'ephemeral': { kurdish: 'کاتی و تێپەڕ', context: 'Transience', alternatives: ['زووگوزەر', 'ناپایەدار'] },
    'ubiquitous': { kurdish: 'لە هەموو شوێنێک بڵاو', context: 'Omnipresent', alternatives: ['هەمەلایەن', 'ئامادە لە هەموو جێیەک'] },
    'resilience': { kurdish: 'خۆڕاگری و بەرگەگرتن', context: 'Endurance', alternatives: ['توانای هەستانەوە', 'پتەوی'] },
    'existential': { kurdish: 'بوونیاری و پەیوەست بە بوون', context: 'Philosophy', alternatives: ['چارەنووسساز'] },
    'catharsis': { kurdish: 'پاکبوونەوەی دەروونی و هەستی', context: 'Psychology/Drama', alternatives: ['ڕزگاربوون لە خەم'] },
    'hubris': { kurdish: 'لووتبەرزی و فیزێکی لەڕادەبەدەر', context: 'Tragedy', alternatives: ['خۆباییبوونی وێرانکەر'] },
    'sublime': { kurdish: 'شکۆدار و باڵا', context: 'Aesthetics', alternatives: ['بێوێنە و مەزن'] },
    'epiphany': { kurdish: 'تێگەیشتنی لەناکاو و ڕۆشنبوونەوەی ئەقڵ', context: 'Revelation', alternatives: ['سەرهەڵدانی ڕاستی'] },
    'transcendent': { kurdish: 'باڵاتر لە سروشت و سنوورەکان', context: 'Philosophy', alternatives: ['تێپەڕێنەری ماددە'] },
    'oblivion': { kurdish: 'لەبیرچوونەوەی یەکجاری و نەمان', context: 'Void', alternatives: ['ونبوون لە تاریکیدا'] },
    'nihilism': { kurdish: 'پووچگەرایی و بێمانایی ژیان', context: 'Philosophy' },
    'stoicism': { kurdish: 'سەنگینی و دانبەخۆداگرتن بەرامبەر ناڕەحەتی', context: 'Philosophy' },
    'introspection': { kurdish: 'خۆپشکنین و قووڵبوونەوە لە ناخی خۆتدا', context: 'Psychology' },
    'solitude': { kurdish: 'تەنیاییەکی ئارامبەخش و پیرۆز', context: 'State of Being' },
    'metamorphosis': { kurdish: 'گۆڕانی بنەڕەتی و شێوەگۆڕکێ', context: 'Transformation' },
    'paradox': { kurdish: 'دژبێژی و هاودژییەکی سەیر', context: 'Logic' },
    'redemption': { kurdish: 'کەفارەت و ڕزگاربوون لە گوناهـ', context: 'Drama' },
    'dystopia': { kurdish: 'جیهانێکی تاریک و وێرانکراو', context: 'Sci-Fi' },
    'utopia': { kurdish: 'شار و جیهانی نموونەیی', context: 'Ideal Realm' },
    'singularity': { kurdish: 'خاڵی تاکی گەردوونی / تەکنەلۆژی', context: 'Sci-Fi' },
    'entropy': { kurdish: 'تێکچوون و پەشێوی سیستەم', context: 'Physics' },
    'hegemony': { kurdish: 'باڵادەستی و هەژموونی دەسەڵات', context: 'Politics' },
    'stalemate': { kurdish: 'بنبەست و وەستانی بێ جووڵە', context: 'Tactics' },
    'nemesis': { kurdish: 'دوژمنی سەرسەخت و لەناوبەر', context: 'Rivalry' },
    'juxtaposition': { kurdish: 'بەراوردکردنی دوو شتی دژبەیەک لە تەنیشت یەک', context: 'Literary' },
    'quintessence': { kurdish: 'جەوهەر و تامی ڕاستەقینەی شتێک', context: 'Core Essence' },
    'magnanimous': { kurdish: 'بەخشندە و دڵفراوان', context: 'Virtue' },
    'clandestine': { kurdish: 'نهێنی و ژێربەژێر', context: 'Espionage' },
    'surreptitious': { kurdish: 'دزەپێکەر و بەدزییەوە', context: 'Stealth' },
    'ineffable': { kurdish: 'وەسفنەکراو و لە دەربڕین بەدەر', context: 'Awe' },
    'sonder': { kurdish: 'هەستکردن بەوەی هەر کەسێک ژیانێکی ئاڵۆزی تایبەت بە خۆی هەیە', context: 'Emotion' },
    'petrichor': { kurdish: 'بۆنی خۆشی باران لەسەر خاکی وشک', context: 'Sensory' },
    'ataraxia': { kurdish: 'ئارامی و هێمنایەتی تەواوی دەروون', context: 'Philosophy' },
    'eudaimonia': { kurdish: 'بەختەوەری و گەشانەوەی مرۆڤ', context: 'Ethics' },
    'zeitgeist': { kurdish: 'ڕۆحی سەردەم و ڕەوتی فکری باو', context: 'Culture' },
    'schadenfreude': { kurdish: 'دڵخۆشبوون بە نەهامەتی کەسانی تر', context: 'Psychology' },
    'verisimilitude': { kurdish: 'ڕاستەقینەنوێنی و وێکچوونی تەواو لەگەڵ واقیع', context: 'Realism' },
    'anachronism': { kurdish: 'نادروستی کاتی و تێکەڵکردنی سەردەمەکان', context: 'History' },
    'hyperbole': { kurdish: 'زێدەڕۆیی لە دەربڕیندا بۆ مەبەستی بەهێزکردن', context: 'Rhetoric' },
    'dichotomy': { kurdish: 'دابەشبوونی دوولایەنەی دژبەیەک', context: 'Logic' },
    'panacea': { kurdish: 'دەرمانی هەموو دەردێک', context: 'Remedy' },
    'plethora': { kurdish: 'زۆری و فرەییەکی لەڕادەبەدەر', context: 'Abundance' },
    'zenith': { kurdish: 'لووتکە و باڵاترین خاڵی سەرکەوتن', context: 'Peak' },
    'nadir': { kurdish: 'نزمترین و قووڵترین خاڵی داڕمان', context: 'Lowest Point' },
    'quandary': { kurdish: 'سەرلێشێواوی و دۆخی دوودڵی لە بڕیارداندا', context: 'Dilemma' },
    'enigma': { kurdish: 'مەتەڵ و نهێنییەکی ئاڵۆز', context: 'Mystery' },
    'conundrum': { kurdish: 'کێشەیەکی سەخت و گرێدار', context: 'Puzzle' },
    'paradigm': { kurdish: 'شێواز و مۆدێلی بنچینەیی بیرکردنەوە', context: 'Science/Philosophy' },
    'antithesis': { kurdish: 'دژ و پێچەوانەی تەواو', context: 'Contrast' },
    'chimerical': { kurdish: 'خەیاڵی و وەهمی نادەستکەوتوو', context: 'Fantasy' },
    'fastidious': { kurdish: 'زۆر وردبین و دەستەوپا لە هەڵبژاردندا', context: 'Precision' },
    'tenacious': { kurdish: 'پێداگر و کۆڵنەدەر', context: 'Perseverance' },
    'voracious': { kurdish: 'تێرنەبوو و پڕ لە حەز', context: 'Desire' },
    'sagacious': { kurdish: 'دانا و خاوەن بیرکردنەوەیەکی ژیرانە', context: 'Wisdom' },
    'perspicacious': { kurdish: 'تیژبین و خاوەن تێگەیشتنی قووڵ', context: 'Insight' },
    'nefarious': { kurdish: 'خراپەکار و بەدکاری بێبەزەیی', context: 'Villainy' },
    'sycophant': { kurdish: 'ماستاوچی و کەسی دەستپێوەگر', context: 'Flattery' },
    'iconoclast': { kurdish: 'ڕێساشکێن و دژ بە نەریتە کۆنەکان', context: 'Rebellion' },
    'maverick': { kurdish: 'کەسی سەربەخۆ کە بە ڕێگەی خۆیدا دەڕوات', context: 'Independence' },
    'pariah': { kurdish: 'کەسی دەستبەردارکراو و وەدەرنراو لە کۆمەڵگە', context: 'Outcast' },
    'polymath': { kurdish: 'زانا لە چەندین بواری جیاوازدا', context: 'Genius' },
    'autodidact': { kurdish: 'کەسێک کە بەخۆی و بەبێ مامۆستا فێربووبێت', context: 'Learning' },
    'luminary': { kurdish: 'کەسایەتی دیار و پێشەنگی ڕووناککەرەوە', context: 'Influence' },
    'virtuoso': { kurdish: 'مامۆستای لێهاتوو و هونەرمەندی بێوێنە', context: 'Mastery' },
  };
  ...
  const UNTRANSLATED_ENGLISH_MAP = {
    ...
    // Core film, drama, everyday and subtitle vocabulary
    'father': 'باوک',
    'mother': 'دایک',
    'parents': 'دایک و باوک',
    'son': 'کوڕ',
    ...
    'probably': 'بە ئەگەری زۆر',
    'actually': 'لە ڕاستیدا',
    'really': 'بەڕاستی',
    'truly': 'بەڕاستی',
    'honestly': 'بە ڕاستگۆیی',
    'together': 'پێکەوە',
    'alone': 'بەتەنیا',
    'tonight': 'ئەمشەو',
    'today': 'ئەمڕۆ',
  ...
  /**
   * Check if an entire subtitle line matches an entry in the ADVANCED_SUBTITLE_LEXICON.
   * Strips outer punctuation, whitespace and tags before lookup.
   * Returns { expression, kurdish, context, alternatives } or null.
   */
  function matchExactLine(text) {
    ...
    const direct = ADVANCED_SUBTITLE_LEXICON[stripped];
    if (direct && direct.kurdish) {
      return {
        expression: stripped,
        kurdish: direct.kurdish,
        context: direct.context || stripped,
