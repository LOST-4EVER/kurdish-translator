...
const AppFullscreen = (() => {
  ...
  function getElements() {
    return {
      ...
      fsCharCount: document.getElementById('fsCharCount') || document.getElementById('fsCharCounter'),
      ...
      fsPrevCueNavBtn: document.getElementById('fsPrevCueNavBtn') || document.getElementById('fsEdPrevCueBtn'),
      fsNextCueNavBtn: document.getElementById('fsNextCueNavBtn') || document.getElementById('fsEdNextCueBtn'),
