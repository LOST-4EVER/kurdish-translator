  ...
  class VideoEditorUIManager {
    ...
    _initElements() {
      this.els = {
        ...
        btnBrowseSubDropzone: $('#studioBrowseSubDropzoneBtn'),
        ...
        toolSubWholeWords: $('#toolSubWholeWords'),
        toolSubMatchCase: $('#toolSubMatchCase'),
        toolSubSearchScope: $('#toolSubSearchScope'),
        ...
        subEffectSel: $('#studioSubEffectSel'),
        ...
        quickPosSel: $('#vnQuickPosSel'),
        quickEffectSel: $('#vnQuickEffectSel'),
